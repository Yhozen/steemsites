...
const navigate = {
    en: {
        ...
        'navigateText': `Steemsites es una nueva forma de crear, hostear y acceder a páginas webss. Gracias al Steem blockchain y WebTorrent ahora puedes generar páginas webs totalmente descentralizadas y
